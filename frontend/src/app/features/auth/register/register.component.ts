  ...
  template: `
    <div class="login-page">
      <form class="card login-card" [formGroup]="form" (ngSubmit)="onSubmit()" novalidate>
        ...
        <p class="login-card__subtitle muted">7 días de prueba gratuita. Sin tarjeta.</p>
        ...
        <div class="login-card__field">
          ...
          <input id="fullName" type="text" formControlName="fullName" autocomplete="name" placeholder="Ana García" />
    ...
    this.auth.register(this.form.getRawValue()).subscribe({
      ...
      error: (err: HttpErrorResponse) => {
        ...
        if (err.status === 400) {
          ...
          this.serverError.set(body?.message ?? 'No se pudo crear la cuenta. Inténtalo de nuevo.');
        }
      }
    });
  }
